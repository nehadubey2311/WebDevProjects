# Generated by Django 3.1.6 on 2021-05-05 22:25
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('category', models.CharField(choices=[('Investing', 'Investing'), ('tech_analysis', 'tech_analysis'), ('fund_analysis', 'fund_analysis')], default='Investing', max_length=20)),
